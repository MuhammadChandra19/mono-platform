...
import { AuthServiceApiOperationScopesMap } from "./client";
import type { AuthServiceApiOperationScopes } from "./client";

/**
 * OAuth scope validation middleware for AuthServiceApi
 */
export class AuthServiceApiServerScopeMiddleware {
   ...
   */
  validateScopes(operationName: keyof AuthServiceApiOperationScopes) {
   ...
   */
  forOperation(operationName: keyof AuthServiceApiOperationScopes) {
